...
namespace KeepersLantern
{
    ...
    public sealed class LanternShadowBoostOptimizedPlugin : BaseUnityPlugin
    {
        ...
        {
            ResolveTypes();
            Logger.LogInfo("Dynamic shadows 1.0.12 loaded. Live DynamicLights.shadows registry only; obsolete snapshot-cache code removed.");
        }
        ...
        private void Update()
        {
            ...
            Logger.LogInfo("F10 SHADOW BOOST | v=1.0.12 active=" + (sharedFade > NightActiveThreshold) +
